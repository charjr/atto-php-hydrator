...
final class FunctionalTest extends TestCase
{
    ...
    public static function provideFixtures(): Generator
    {
        $fixtures = [
            ...
            Arrays\Flat\Objects\Enums::class,
            Arrays\Nested\Scalars::class,
            Objects\Flat\DateTimes::class,
            Objects\Flat\IntBackedEnums::class,
            Objects\Flat\StringBackedEnums::class,
            // Objects\Flat\UnitEnums::class,
            Objects\Flat\StringWrappers::class,
            Objects\Flat\Nullable\DateTimes::class,
            Objects\Flat\Nullable\StringBackedEnums::class,
            Objects\Flat\Nullable\StringWrappers::class,
